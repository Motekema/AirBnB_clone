#!/usr/bin/python3
"""It test for FileStorage in models/file_storage.py."""
import os.path
import unittest
...
class TestFileStorageInit(unittest.TestCase):
    """It contains test cases against the FileStorage initialization"""

    def test_file_path_is_a_private_class_attr(self):
        """It checks that file_path is private class attribute"""
        self.assertFalse(hasattr(FileStorage(), "__file_path"))

    def test_objects_is_a_private_class_attr(self):
        """It checks that objects is private class attribute"""
        self.assertFalse(hasattr(FileStorage(), "__objects"))

    def test_init_without_arg(self):
        """It tests initialization without args"""
        self.assertEqual(type(FileStorage()), FileStorage)

    def test_init_with_arg(self):
        """It tests initialization with args"""
        with self.assertRaises(TypeError):
            FileStorage(None)

    def test_storage_initialization(self):
        """It tests storage created in __init__.py"""
        self.assertEqual(type(models.storage), FileStorage)


class TestStorageMethods(unittest.TestCase):
    """It ontains test cases against methods present in FileStorage"""

    @classmethod
    def setUp(self):
        """The code - execute before testing occurs"""
        try:
    ...
    @classmethod
    def tearDown(self):
        """A code - execute after tests are executed"""
        # It remove file.json if it exists
        try:
            os.remove("file.json")
        except IOError:
            pass

        # It rename tmp.json from setUp() to file.json
        try:
    ...
    def test_all_method(self):
        """It tests *() method of FileStorage class"""
    ...
    def test_new_method(self):
        """It tests new() method of FileStorage class"""
        dummy_bm = BaseModel()
        dummy_user = User()
        dummy_state = State()
        dummy_city = City()
        ...
        # It checks that objects created above are stored already
        ...
        # What if None was passed? That guy needs learn lesson...
        # AttributeError, will you join us?
        with self.assertRaises(AttributeError):
            models.storage.new(None)

    def test_save_method(self):
        """It is Time - deal with reload() method in FileStorage class"""
        dummy_bm = BaseModel()
        dummy_user = User()
        dummy_state = State()
        dummy_city = City()
        ...
        # It happens when an arg is passed? TypeError has been my agent!
        with self.assertRaises(TypeError):
    ...
    def test_reload_method(self):
        ...
        # It happens when arg is passed? TypeError is raised.
        with self.assertRaises(TypeError):
