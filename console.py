#!/usr/bin/python3
"""Command-line interface for an AirBnB clone web application.

This script provides a console that allows users to interact with different classes
such as BaseModel, User, City, Place, State, Amenity, and Review. Users can perform
actions like creating new instances, showing instance details, listing all instances,
destroying instances, updating attributes, and counting instances.
